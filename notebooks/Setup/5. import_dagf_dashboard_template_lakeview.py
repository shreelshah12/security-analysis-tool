...
file_path = f'{basePath()}/dashboards/SAT_Databricks_AI_Governance_Framework_definition.json'
...
BODY = {'path': f'{basePath()}/[SAT] Databricks AI Governance Framework - Workspace In-Depth.lvdash.json'}
...
import requests
json_file_path = f"{basePath()}/dashboards/SAT_Databricks_AI_Governance_Framework_definition.json"
...
BODY = {'display_name': '[SAT] Databricks AI Governance Framework - Workspace In-Depth','warehouse_id': json_['sql_warehouse_id'], 'serialized_dashboard': json_string, 'parent_path': f"{basePath()}/dashboards"}
